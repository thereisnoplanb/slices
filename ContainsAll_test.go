...
func TestContainsAllFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotResult := ContainsAllFunc(tt.args.source, tt.args.equality, tt.args.values...); gotResult != tt.wantResult {
				t.Errorf("ContainsAllFunc() = %v, want %v", gotResult, tt.wantResult)
			}
		})
	}
}

func TestContainsAllEquatable(t *testing.T) {
	type args struct {
		source []time.Time
		values []time.Time
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotResult := ContainsAllEquatable(tt.args.source, tt.args.values...); gotResult != tt.wantResult {
				t.Errorf("ContainsAllEquatable() = %v, want %v", gotResult, tt.wantResult)
			}
		})
	}
}
